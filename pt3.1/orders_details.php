  ...
  <body>
    ...
    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
      <div class="panel panel-default">
        ...
        <div class="panel-heading" style="color: black;"><strong>Order Details</strong></div>
   ...
   <div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          <label for="prd" class="col-sm-3 control-label"style="color:white "required>Product</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
          <label for="qty" style="color: whitesmoke;" class="col-sm-3 control-label"style="color:white ">Quantity</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
        ...
        <button class="btn btn-default" style="background-color:white;" type="submit" name="addproduct"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
...
<center>
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2"style="color:white">
      <div class="page-header">
        <h2>Order Details</h2>
      </div>
