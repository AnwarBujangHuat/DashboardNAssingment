...
<center>
 ...
 <div class="form-group">
          <label for="oid" class="col-sm-3 control-label" style="color:white">ORDER ID</label>
          <div class="col-sm-9">
      <input name="oid" id="oid" type="text" class="form-control"  readonly value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_ORDER_ID']; else echo $num?>"?><br>
      </div>
        </div>
      <div class="form-group">
          <label for="odate" class="col-sm-3 control-label"style="color:white">ORDER DATE & TIME</label>
          <div class="col-sm-9">
      <input name="odate" type="text" class="form-control" id="odate"  readonly value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_DATE_ORDERED']; ?>"> <br>
      </div>
        </div>
      <div class="form-group">
...
<div class="form-group">
  <label for="cid" class="col-sm-3 control-label"style="color:white">CUSTOMER ID</label>
  <div class="col-sm-9">
...
<div class="row">
    ...
    <table class="table" style="color:white"  style="text-align: center">
      <thead>
        <tr>
          <td>Order ID</td>
          <td>Order Date</td>
        ...
        try {
          ...
          $sql = $sql."tbl_order_a177016_pt2.FLD_CUSTOMER_ID = tbl_customer_a177016_pt2.FLD_CUSTOMER_ID ORDER BY FLD_ORDER_ID ASC LIMIT $start_from, $per_page";
