...
<div class="col-xs-6 text-center">
  <br>
    <img src="logo.png" sizes="20%">
</div>
<div class="col-xs-6 text-right">
  <h1>INVOICE</h1>
  <h5>Order: <?php echo $readrow['FLD_ORDER_ID'] ?></h5>
  <h5>Date: <?php echo $readrow['FLD_DATE_ORDERED'] ?></h5>
</div>
</div>
<hr>
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Luxurious Time Piece Collection(Swiss Edition) Sdn. Bhd.</h4>
      </div>
    ...
    <div class="col-xs-5 col-xs-offset-2 text-right">
      ...
      Taman Desa Surada 2,<br> 
       SEKSYEN 8, Bandar Baru Bangi, <br>
       Selangor, <br>
       Darul Ehsan <br>
        </p>
            </div>
    ...
    <div class="span7">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <p> Email: <?php echo $readrow['FLD_STAFF_PHONE_NUMBER'] ?> </p>
          <p><br></p>
          <p><br></p>
