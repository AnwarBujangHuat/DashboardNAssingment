...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_staff_a177016_pt2(FLD_STAFF_ID, FLD_STAFF_NAME, FLD_STAFF_PHONE_NUMBER) VALUES(:sid, :sname, :sphone)");
   
    $stmt->bindParam(':sid', $sid, PDO::PARAM_STR);
    $stmt->bindParam(':sname', $sname, PDO::PARAM_STR);
    $stmt->bindParam(':sphone', $sphone, PDO::PARAM_INT);
