...
if (isset($_POST['create'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("INSERT INTO tbl_product_a177016_pt2(FLD_PRODUCT_ID, FLD_BRAND, FLD_PRODUCT_NAME, FLD_PRICE,FLD_DIAL_COLOUR, FLD_STRAP_COLOUR,FLD_GENDER,FLD_DIAMETER,FLD_WARRANTY,FLD_QUANTITY) VALUES(:pid, :pbrand, :pname, :pprice, :pdial, :pstrap,:pgender,:pdiameter, :pwarranty, :pquantity)");
