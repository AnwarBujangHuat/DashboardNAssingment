...
<body data-new-gr-c-s-check-loaded="14.1006.0" data-gr-ext-installed="" class="clickup-chrome-ext_installed">
  ...
  <center>
    ...
    <div style="margin: 0 10%">
      ...
      <br><label for="pgender">Gender</label>
      <input name="pgender" id="gender" type="radio" value="Male" <?php if(isset($_GET['edit'])) if($editrow['FLD_GENDER']=="Male") echo "checked"; ?>>Male
      <input name="pgender" id="gender" type="radio" value="Female" <?php if(isset($_GET['edit'])) if($editrow['FLD_GENDER']=="Female") echo "checked"; ?>>Female
      <input name="pgender" id="gender" type="radio" value="Unisex" <?php if(isset($_GET['edit'])) if($editrow['FLD_GENDER']=="Unisex") echo "checked"; ?>>Unisex
      <br>
