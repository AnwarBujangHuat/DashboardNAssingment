                ...
                <td>
                    <form>
                        <ul>
                            ...
                            <li>
                                <label style="display: inline-block;width: 160px; text-align: left;">Product Bezel</label>
                                <label>:</label>
                                <label class="Product Color"><?php echo $readrow['FLD_BEZEL'] ?> <br></label>
                            </li>
                             <li>
                            ...
                            <li>
                               ...
                               <li>
                                <label style="display: inline-block;width: 160px; text-align: left;">Details</label>
                                <label>:</label>
                                <label class="details"> <?php echo $readrow['FLD_DETAIL'] ?> <br></label>
                            </li>
                              </li>
                               <li>
