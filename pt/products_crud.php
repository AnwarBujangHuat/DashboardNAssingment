...
if (isset($_POST['create'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("INSERT INTO tbl_product_a177016_pt2(FLD_PRODUCT_ID,
        FLD_BRAND, FLD_PRODUCT_NAME, FLD_PRICE, FLD_BEZEL,FLD_DIAL_COLOUR, FLD_STRAP_COLOUR,FLD_GENDER,FLD_DETAIL,FLD_DIAMETER,FLD_WARRANTY,FLD_QUANTITY ) VALUES(:pid, :pbrand, :pname, :pprice,:pbezel, :pdial, :pstrap,:pgender,:pdetail,:pdiameter, :pwarranty, :pquantity)");
      ...
      $stmt->bindParam(':pdetail', $pdetail, PDO::PARAM_STR);
...
if (isset($_POST['update'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("UPDATE tbl_product_a177016_pt2 SET FLD_PRODUCT_ID = :pid,
        ...
        FLD_GENDER = :pgender, FLD_DETAIL = :pdetail, FLD_DIAMETER = :pdiameter,
